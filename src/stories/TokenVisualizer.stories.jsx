  ...
  return (
    <div className="auto-p-4">
      ...
      <p className="auto-body-default auto-mb-6">
        All colors are accessed through CSS classes like <code className="auto-font-mono auto-text-accent">auto-bg-primary</code> and <code className="auto-font-mono auto-text-accent">auto-text-secondary</code>.
      </p>
...
export const TypographyDisplay = () => {
  ...
  return (
    <div className="auto-p-4">
      ...
      <p className="auto-body-default auto-mb-6">
        Typography is accessed through CSS classes like <code className="auto-font-mono auto-text-accent">auto-heading-1</code> and <code className="auto-font-mono auto-text-accent">auto-body-default</code>.
      </p>
...
export const SpacingDisplay = () => {
  ...
  return (
    <div className="auto-p-4">
      ...
      <p className="auto-body-default auto-mb-6">
        Spacing is accessed through CSS classes like <code className="auto-font-mono auto-text-accent">auto-m-4</code> and <code className="auto-font-mono auto-text-accent">auto-p-2</code>.
      </p>
      ...
      <div className="auto-mb-8 auto-p-4 auto-bg-secondary auto-rounded-lg">
        ...
        {spacingSizes.slice(1, 5).map(size => (
          <div key={size.name} className="tw-flex">
            <div className={`auto-bg-accent auto-rounded-sm auto-p-2 auto-mb-${size.name} tw-w-[200px]`}>
