...
//       Text color classes follow the pattern <code className="auto-code">auto-text-*</code> and can
//       be applied to any element.
//     </p>

//     <div className="auto-py-4">
//       <p className="auto-text-primary auto-body-default auto-mb-2">
//         Primary Text - auto-text-primary
//       </p>
//       <p className="auto-text-secondary auto-body-default auto-mb-2">
//         Secondary Text - auto-text-secondary
//       </p>
//       <p className="auto-text-tertiary auto-body-default auto-mb-2">
//         Tertiary Text - auto-text-tertiary
//       </p>
//       <p className="auto-text-disabled auto-body-default auto-mb-2">
//         Disabled Text - auto-text-disabled
//       </p>
//       <p className="auto-text-error auto-body-default auto-mb-2">Error Text - auto-text-error</p>
//       <p className="auto-text-success auto-body-default auto-mb-2">
//         Success Text - auto-text-success
//       </p>
//       <p className="auto-text-warning auto-body-default auto-mb-2">
//         Warning Text - auto-text-warning
//       </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Background color classes follow the pattern <code className="auto-code">auto-bg-*</code> and
//       can be applied to any element.
//     </p>

//     <div className="auto-py-4">
//       <div className="auto-bg-primary auto-p-4 auto-mb-2 auto-rounded">
//         Primary Background - auto-bg-primary
//       </div>
//       <div className="auto-bg-secondary auto-p-4 auto-mb-2 auto-rounded">
//         Secondary Background - auto-bg-secondary
//       </div>
//       <div className="auto-bg-tertiary auto-p-4 auto-mb-2 auto-rounded">
//         Tertiary Background - auto-bg-tertiary
//       </div>
//       <div className="auto-bg-error auto-p-4 auto-mb-2 auto-rounded">
//         Error Background - auto-bg-error
//       </div>
//       <div className="auto-bg-success auto-p-4 auto-mb-2 auto-rounded">
//         Success Background - auto-bg-success
//       </div>
//       <div className="auto-bg-warning auto-p-4 auto-mb-2 auto-rounded">
//         Warning Background - auto-bg-warning
//       </div>
//       <div className="auto-bg-info auto-p-4 auto-mb-2 auto-rounded">
//         Info Background - auto-bg-info
//       </div>
//       <div className="auto-bg-accent auto-p-4 auto-mb-2 auto-rounded">
//         Accent Background - auto-bg-accent
//       </div>
//     </div>

//     <h2 className="auto-heading-2 auto-mt-8">Button Classes</h2>
//     <p className="auto-body-default auto-mb-6">
//       Button classes follow the pattern <code className="auto-code">auto-button-*</code> and are
//       typically applied to button elements.
//     </p>
...
//       <button className="auto-button-disabled auto-p-2 auto-px-4 auto-rounded" disabled>
//         Disabled Button
//       </button>
//     </div>
//   </div>
...
//     <p className="auto-body-default auto-mb-6">
//       Heading classes follow the pattern <code className="auto-code">auto-heading-*</code> and
//       provide all the typography settings for headings.
//     </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Body text classes follow the pattern <code className="auto-code">auto-body-*</code> and
//       provide typography settings for body text.
//     </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Font size classes follow the pattern <code className="auto-code">auto-text-*</code> and can be
//       combined with other typography classes.
//     </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Font weight classes follow the pattern <code className="auto-code">auto-font-*</code> and can
//       be combined with other typography classes.
//     </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Margin classes follow the pattern <code className="auto-code">auto-m-*</code> and can be
//       applied to any element.
//     </p>

//     <div className="auto-py-4">
//       <div className="auto-bg-secondary auto-p-2 auto-rounded auto-text-center auto-m-1">
//         auto-m-1
//       </div>
//       <div className="auto-bg-secondary auto-p-2 auto-rounded auto-text-center auto-m-2">
//         auto-m-2
//       </div>
//       <div className="auto-bg-secondary auto-p-2 auto-rounded auto-text-center auto-m-4">
//         auto-m-4
//       </div>
//       <div className="auto-bg-secondary auto-p-2 auto-rounded auto-text-center auto-m-8">
//         auto-m-8
//       </div>
//     </div>
...
//     <p className="auto-body-default auto-mb-6">
//       Padding classes follow the pattern <code className="auto-code">auto-p-*</code> and can be
//       applied to any element.
//     </p>
...
//     <p className="auto-body-default auto-mb-6">
//       Border radius classes follow the pattern <code className="auto-code">auto-rounded-*</code> and
//       can be applied to any element.
//     </p>
...
//       <p className="auto-body-default auto-mb-6">
//         Use the <code className="auto-code">auto-theme-dark</code> class on any container to apply
//         dark theme styles to all children.
//       </p>
...
//           This content will change based on the theme. The current theme is:{' '}
