...
// In a real app outside the monorepo, you would use:
// import "@autonomys/design-tokens/dist/css/explorer.css";
// Or for all styles:
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Examples of using Auto Design Explorer styles with CSS utility classes. These styles are now in a separate CSS file for more flexible importing.',
      },
    },
    layout: 'padded',
  },
...
export const ExplorerColors = () => (
  <div>
    ...
    <p className="auto-body-default auto-mb-6">
      Explorer background color classes follow the pattern <code className="auto-code">auto-explorer-bg-*</code> and can be applied to any element.
    </p>
    
    <div className="auto-py-4 tw-grid tw-grid-cols-2 md:tw-grid-cols-4 tw-gap-4">
      <div className="auto-explorer-bg-grayDark auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">grayDark</div>
      <div className="auto-explorer-bg-grayDarker auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">grayDarker</div>
      <div className="auto-explorer-bg-grayLight auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">grayLight</div>
      <div className="auto-explorer-bg-gradientFrom auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">gradientFrom</div>
      <div className="auto-explorer-bg-gradientVia auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">gradientVia</div>
      <div className="auto-explorer-bg-gradientTo auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">gradientTo</div>
      <div className="auto-explorer-bg-whiteOpaque auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">whiteOpaque</div>
      <div className="auto-explorer-bg-primaryAccent auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">primaryAccent</div>
      <div className="auto-explorer-bg-blueAccent auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">blueAccent</div>
      <div className="auto-explorer-bg-blueLight auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">blueLight</div>
      <div className="auto-explorer-bg-blueShade auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">blueShade</div>
      <div className="auto-explorer-bg-blueUndertone auto-p-4 auto-mb-2 auto-rounded auto-explorer-text-white">blueUndertone</div>
    </div>
    
    <h2 className="auto-heading-2 auto-mt-8">Explorer Text Colors</h2>
    <p className="auto-body-default auto-mb-6">
      Explorer text color classes follow the pattern <code className="auto-code">auto-explorer-text-*</code> and can be applied to any element.
    </p>
    
    <div className="auto-py-4 tw-grid tw-grid-cols-2 md:tw-grid-cols-3 tw-gap-4">
      <p className="auto-explorer-text-primaryAccent auto-body-default auto-mb-2">Primary Accent - auto-explorer-text-primaryAccent</p>
      <p className="auto-explorer-text-blueAccent auto-body-default auto-mb-2">Blue Accent - auto-explorer-text-blueAccent</p>
      <p className="auto-explorer-text-blueDarkAccent auto-body-default auto-mb-2">Blue Dark Accent - auto-explorer-text-blueDarkAccent</p>
      <p className="auto-explorer-text-blueLight auto-body-default auto-mb-2">Blue Light - auto-explorer-text-blueLight</p>
      <p className="auto-explorer-text-blueShade auto-body-default auto-mb-2">Blue Shade - auto-explorer-text-blueShade</p>
      <p className="auto-explorer-text-blueUndertone auto-body-default auto-mb-2">Blue Undertone - auto-explorer-text-blueUndertone</p>
    </div>
  </div>
);
...
export const ExplorerGradients = () => (
  <div>
    ...
    <p className="auto-body-default auto-mb-6">
      Explorer gradient classes follow several patterns for different use cases like backgrounds, buttons, and cards.
    </p>
    ...
    <div className="auto-explorer-bg-backgroundDarker auto-p-6 auto-rounded-lg">
      <div className="auto-explorer-card-gradient-primary auto-p-4 auto-rounded">
        ...
        <p className="auto-body-default auto-explorer-text-whiteOpaque auto-mt-2">
          This component uses Explorer-specific colors and gradients that are now available in a separate CSS file.
        </p>
